            ...
            with open(self.csvFile, 'rb') as csvfile:
                ...
                for row in spamreader:
                    ...
                    if rowCount == 0:
                        ...
                        '''
                        newFile = open(self.destinationFolder+"/newFile.tex","a+")
                        newFile.write(newFileContent)
                        newFile.close()
                        create_pdf(self.destinationFolder+"/newFile.tex","Testen/"+onderwerp+" "+voornaam+" "+achternaam)
                        if self.CheckVar6.get() == 0:
                            os.remove(self.destinationFolder+"/newFile.tex")
                        rowCount = rowCount+1
            logFile.close()
